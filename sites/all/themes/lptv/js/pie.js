...
Raphael.el.tooltip = function (tp) {
 ...
 function swapItems(){
	...
	jQuery.each(jQuery("[src*='covers/image']"), function() {
		jQuery(this).attr('src', imagesArray[Math.floor(Math.random()*imagesArray.length-1)]);
	});
}
...
jQuery(function () {
    var values = [],
        labels = [];
    jQuery("#graphix tr").each(function () {
