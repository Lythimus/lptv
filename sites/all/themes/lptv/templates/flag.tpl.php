...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php switch ($flag_name_css) {
    case 'interrupts-game-yes':
      print '<div class="lp-question">'.t('Does the LPer interrupt the game').'</div>';
    break;
    case 'cursing-vulgarity-yes':
      print '<div class="lp-question">'.t('Is the LPer cursing or vulgar').'</div>';
    break;
    case 'completed-yes':
      print '<div class="lp-question">'.t('Is the LP complete').'</div>';
    break;
    case 'commercials-yes':
      print '<div class="lp-question">'.t('Does the LP have commercials').'</div>';
    break;
    case 'walkthrough-yes':
      print '<div class="lp-question">'.t('Is the LP a walkthrough').'</div>';
    break;
    case 'game-audio-yes':
      print '<div class="lp-question">'.t('Does the LP have the game audio').'</div>';
    break;
    case 'video-clips-yes':
      print '<div class="lp-question">'.t('Does the LP contain video clips').'</div>';
    break;
    case 'voice-acting-yes':
      print '<div class="lp-question">'.t('Does the LPer do voice acting').'</div>';
    break;
    case 'edited-yes':
      print '<div class="lp-question">'.t('Is the LP video edited').'</div>';
    break;
  } ?>
  <?php if ($link_href): ?>
