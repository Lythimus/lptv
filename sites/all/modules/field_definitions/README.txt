...
Field Definitions displays content type fields with their descriptions in
...
For a full description visit the project page:
  http://drupal.org/project/field_definitions
Bug reports, feature suggestions and latest developments:
  http://drupal.org/project/issues/field_definitions


-- USE --

Go to http://www.example/com/field_definitions to view the field definitions. Don't
forget to enable the 'view field definitions' permission.


-- CONFIGURATION --

* Configure user permissions in Administer >> User management >> Access
  control >> field_definitions module:

  - administer field definitions: Allows users to enable/disable the functionality
    in each content type and edit overall administrative settings. 

  - view field definitions: Allows users to view the definitions for enabled content
    types.
    
  - edit field definitions: Allows users to change field definitions from within the
    dictionary view.
